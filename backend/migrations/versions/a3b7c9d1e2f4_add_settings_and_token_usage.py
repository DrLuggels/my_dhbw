...
def upgrade() -> None:
    op.create_table('app_settings',
        ...
        sa.Column('openai_model', sa.String(length=100), nullable=False, server_default='gpt-5-mini'),
        sa.Column('anthropic_model', sa.String(length=100), nullable=False, server_default='claude-sonnet-4-6'),
        sa.Column('gemini_model', sa.String(length=100), nullable=False, server_default='gemini-3-flash-preview'),
