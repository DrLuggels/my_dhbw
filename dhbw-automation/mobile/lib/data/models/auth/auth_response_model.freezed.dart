...
abstract class $AuthResponseModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String token, String? refreshToken, UserModel user, String? expiresAt});
...
class _$AuthResponseModelImpl implements _AuthResponseModel {
  ...
  @override
  String toString() {
    return 'AuthResponseModel(token: $token, refreshToken: $refreshToken, user: $user, expiresAt: $expiresAt)';
  }
...
abstract class _AuthResponseModel implements AuthResponseModel {
  const factory _AuthResponseModel(
      ...
      final String? expiresAt}) = _$AuthResponseModelImpl;
