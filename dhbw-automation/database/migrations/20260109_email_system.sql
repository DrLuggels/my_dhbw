...
-- ============================================================================
-- SQLite Alternative (for local development)
-- ============================================================================
-- If using SQLite, use this instead:
/*
-- Add Email sync columns to Users table
ALTER TABLE Users ADD COLUMN EmailSyncEnabled INTEGER NOT NULL DEFAULT 0;
ALTER TABLE Users ADD COLUMN EmailSyncAddress TEXT NULL;
ALTER TABLE Users ADD COLUMN EmailSyncPassword TEXT NULL;
ALTER TABLE Users ADD COLUMN EmailImapHost TEXT NULL;
ALTER TABLE Users ADD COLUMN EmailImapPort INTEGER NULL DEFAULT 993;
ALTER TABLE Users ADD COLUMN EmailSmtpHost TEXT NULL;
ALTER TABLE Users ADD COLUMN EmailSmtpPort INTEGER NULL DEFAULT 587;
ALTER TABLE Users ADD COLUMN EmailSyncIntervalMinutes INTEGER NULL DEFAULT 15;
ALTER TABLE Users ADD COLUMN LastEmailSync TEXT NULL;
ALTER TABLE Users ADD COLUMN EmailSyncLastError TEXT NULL;
ALTER TABLE Users ADD COLUMN EmailSyncEnabled_At TEXT NULL;
...
CREATE TABLE IF NOT EXISTS Emails (
    ...
    Category TEXT NULL,
    IsAppointment INTEGER NOT NULL DEFAULT 0,
    RequiresUserAction INTEGER NOT NULL DEFAULT 0,
    ...
    ActionTakenAt TEXT NULL,
    RelatedCalendarEventId INTEGER NULL,
    RelatedTodoId INTEGER NULL,
...
CREATE INDEX IF NOT EXISTS idx_user_received ON Emails(UserId, ReceivedDate DESC);
CREATE INDEX IF NOT EXISTS idx_is_read ON Emails(IsRead);
CREATE INDEX IF NOT EXISTS idx_is_processed ON Emails(IsProcessed);
CREATE INDEX IF NOT EXISTS idx_category ON Emails(Category);
CREATE UNIQUE INDEX IF NOT EXISTS idx_user_message ON Emails(UserId, MessageId);
...
CREATE TABLE IF NOT EXISTS EmailAttachments (
    ...
    RelatedDocumentId INTEGER NULL,
...
CREATE INDEX IF NOT EXISTS idx_email_id ON EmailAttachments(EmailId);
*/
